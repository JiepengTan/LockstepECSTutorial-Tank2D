...
namespace Lockstep.Game{
    public partial class EntityUtil{
        private static GameEntity CreateEntityBullet(GameContext context){
            var entity = context.CreateEntity();
            AddComponent<Lockstep.ECS.Game.OwnerComponent>(entity,GameComponentsLookup.Owner);
            AddComponent<Lockstep.ECS.Game.BulletComponent>(entity,GameComponentsLookup.Bullet);
            AddComponent<Lockstep.ECS.Game.TagBulletComponent>(entity,GameComponentsLookup.TagBullet);
        ...
        public static GameEntity CreateEntityBullet(GameContext context, ushort prefabId){
            var entity = CreateEntityBullet(context);
            var tblData = Table_ConfigBullet.GetData(prefabId);
            tblData.AssignToEntity(entity);
            return entity; 
        }
    }
    public partial class Table_ConfigBullet :IAssignToEntity
    {
        public void AssignToEntity(object entityObj){ 
            var entity = (GameEntity)entityObj;
            entity.asset.assetId = asset;
            entity.bullet.canDestoryIron = bullet_canDestoryIron;
            entity.bullet.canDestoryGrass = bullet_canDestoryGrass;
